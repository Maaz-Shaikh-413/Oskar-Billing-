        ...
        <div class="page-sidebar">
            <ul class="list-unstyled accordion-menu">
                ...
                <li class="active-page">
                    <a href="index.html" class="active"><i data-feather="list"></i>Tables<i
                            class="fas fa-chevron-right dropdown-icon"></i></a>
                    <ul class="">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-description">Due to the widespread use of <code>&lt;table&gt;</code>
                                    elements across third-party widgets like calendars and date pickers, Bootstrap’s
                                    tables are opt-in. Add the base class <code>.table</code> to any
                                    <code>&lt;table&gt;</code>, then extend with our optional modifier classes or custom
                                    styles. All table styles are not inherited in Bootstrap, meaning any nested tables
                                    can be styled independent from the parent.</p>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
